...
export const MISSAO_VALORES = [
  {
    titulo: 'Missão',
    descricao:
      'Conectar estudantes, desenvolver talentos e gerar impacto positivo por meio da gestão de projetos.',
    gradiente: 'bg-[linear-gradient(180deg,#2A0A5C_0%,#4F17A8_100%)]',
  },
  {
    titulo: 'Visão',
    descricao:
      'Ser uma referência universitária em gestão de projetos, impulsionada por uma comunidade engajada que cresce e gera impacto na sociedade.',
    gradiente: 'bg-[linear-gradient(180deg,#012029_0%,#00799E_100%)]',
  },
  {
    titulo: 'Valores',
    descricao:
      'Juntos podemos mais, Pertencimento, Protagonismo estudantil, Pense grande, Facilite',
...
export const FAQ_STUDENT = [
  ...
  {
    pergunta:
      'Sou de um curso que não tem nada a ver com projetos. Posso participar?',
    resposta:
