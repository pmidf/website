...
import { HERO } from "@/content/presidentes";

/**
 * Dobra inicial, no mesmo gradiente do Hero de Quem Somos — esta página é a
 * continuação daquela Seção 5, e a faixa colorida é o que amarra as duas.
 */
